...
@referers = ('sslhost.de','www.sslhost.de');
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        else { print "   <h1>Vielen Dank fuer Ihre Eingaben</h1>\n" }

        print "</center>\n";

        print "Ihre Daten wurden weitergeleitet zu $Config{'recipient'} on ";
...
A Free Product of <a href="http://www.worldwidemart.com/scripts/">Matt's Script Archive, Inc.</a><br></br><a href="http://www.htl.de">(c) by HTL-Multimedia</a></font></center>
        </body>
       </html>
(END HTML FOOTER)
    }
...
<html>
 <head>
  ...
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Error: Fehlende Eingaben</font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>The folgende Felder sind nicht ausgefüllt worden:<p>
     <ul>
$missing_field_list
     </ul><br>

     Diese Felder müssen Sie vor dem Abschicken des Formularen ausfüllen.<p>
     Klicken Sie bitte auf ZURÜCK/BACK in Ihrem Browser und füllen Sie bitte das Formular komplett aus.<hr size=1>
     <center><font size=-1>
      <a href="http://www.worldwidemart.com/scripts/formmail.shtml">FormMail</a> V1.6 &copy; 1995 - 1997  Matt Wright<br>
      A Free Product of <a href="http://www.worldwidemart.com/scripts/">Matt's Script Archive, Inc. (c) by HTL-Multimedia</a>
     </font></center>
    </td></tr>
   </table>
  </center>
